...
performDE = function(cell_type){
  ...
  simulated_path = paste0('combination_matrix_gamma_multiclass_shared/', cell_type)
  nn_path = paste0('combination_binary_gamma_multiclass_shared/', cell_type) # change
  save_path = paste0('de_analysis_combination_binary_gamma_multiclass_shared/', cell_type) # change
